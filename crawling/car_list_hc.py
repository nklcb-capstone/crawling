...
url='https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=%EC%88%98%EC%86%8C%EC%B0%A8+%ED%95%B4%EC%99%B8&oquery=%EC%88%98%EC%86%8C%EC%B0%A8+%EC%A0%84%EC%B2%B4&tqi=h5dfKlp0YihssKMCuBwssssssCs-088283'
    ...
    with conn.cursor() as curs:
        for item in allCarElement:
            ...
            if (CarName != ''):
                ...
                curs.execute(sql, (carnum, CarName, '수소차', CarMileage, ahref, imgUrl))
            conn.commit()
            carnum+=1
